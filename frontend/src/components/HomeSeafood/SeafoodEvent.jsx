...
import '../../styles/homeSeafood/seafoodEvent.css';
...
const SeafoodEvent = () => {
    ...
    return (
        <section id="events">
            <div className="seafood-events-paralax">
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <div className='events-inner'>
                                <div className='seafood-events-header'>
                                    <p>Upcomming</p>
                                    <h1>EVENTS</h1>
                                </div>
                                <div className='inner-slider'>
                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <div className='carousel-item-content'>
                                                    ...
                                                    <div className='seafood-inner-event-slider-content'>
                                                        <h5>Wine Testings</h5>
                                                    ...
                                                    <div className='seafood-inner-date'>
                                                        <div className='seafood-date-boxs'>
                                                            <div className='seafood-date-box'>
                                    ...
                                    <div className='my-5'>
                                        <button className='seafood-events-slider-button seafood-events-slider-button-active' type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"></button>
