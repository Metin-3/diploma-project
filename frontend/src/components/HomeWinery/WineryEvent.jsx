...
import '../../styles/homeWinery/wineryEvent.css';
...
const WineryEvent = () => {
    ...
    return (
        <section id="events">
            <div className="winery-events-paralax">
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <div className='events-inner'>
                                <div className='winery-events-header'>
                                    <p>Upcomming</p>
                                    <h1>EVENTS</h1>
                                </div>
                                <div className='inner-slider'>
                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <div className='carousel-item-content'>
                                                    ...
                                                    <div className='winery-inner-event-slider-content'>
                                                        <h5>Wine Testings</h5>
                                                    ...
                                                    <div className='winery-inner-date'>
                                                        <div className='winery-date-boxs'>
                                                            <div className='winery-date-box'>
                                    ...
                                    <div className='my-5'>
                                        <button className='winery-events-slider-button winery-events-slider-button-active' type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"></button>
                                        <button className='winery-events-slider-button' type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                        <button className='winery-events-slider-button' type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
