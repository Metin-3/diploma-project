...
import '../../styles/homeWinery/wineryNew.css'
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-12">
                        <div className='winery-new-header'>
                            <p>What</p>
                            <h1>NEW?</h1>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12 my-3">
                        <div className="new-card">
                            <div className='winery-from-blog-header'>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12 my-3">
                        <div className="new-card">
                            ...
                            <div className="twitter-content">
                                <p><Link to="https://twitter.com/realseojoe" className='winery-twitter-link'>@realseojoe</Link> why thank you sir! We'd love to show you around 🙂 ^Dan <span className='py-3'><em>Agu 13 2014</em></span></p>

                                <p>With heartfelt thanks to YOU we have busted into the World's Top 100 ranking on Alexa! WOOHOO! <br /><Link to="https://www.envato.com/blog/australian-website-themeforest-breaks-into-worlds-top-100/" className='winery-twitter-link'> http://t.co/IknnsXr1S1 </Link><span className='py-3'><em>Agu 12 2014</em></span></p>

                                <p>RT <Link to="https://twitter.com/envato" className='winery-twitter-link'>@envato</Link>: #EnvatoStories: By selling one #WP theme on ThemeForest <Link to="https://twitter.com/mharis" className='winery-twitter-link'>@mharis</Link> has been able to build a house for his entire family https://t.…<span className='py-3'><em>Agu 11 2014</em></span></p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12 my-3">
