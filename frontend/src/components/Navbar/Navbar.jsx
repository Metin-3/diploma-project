                            ...
                            <ul className='navbar-list'>
                                ...
                                <li className='navbar-list-item'>
                                    ...
                                    <ul className='navbar-list-dropdown'>
                                        ...
                                        <hr className='me-3' />
                                        <li className='navbar-list-dropdown-item'>
                                            <Link to="/" className='navbar-list-dropdown-item-link'>Upcoming Events</Link>
                                        </li>
                                        <hr className='me-3' />
                                        <li className='navbar-list-dropdown-item'>
                                            <Link to="/" className='navbar-list-dropdown-item-link'>Expired Events</Link>
                                        </li>
                                        <hr className='me-3' />
                                        <li className='navbar-list-dropdown-item mb-3'>
                                            <Link to="/" className='navbar-list-dropdown-item-link'>Single Event</Link>
                                        </li>
                                    </ul>
                                </li>
                                <li className='navbar-list-item'>
